...
| **F1** | **Common CAD Contracts** | F0 (SATISFIED) | `CORRECTED_DRAFT (v0.4.0) / INDEPENDENT_RE_REVIEW_PENDING` | `NONE` | `NOT_STARTED / NOT AUTHORIZED` | NO | **SPEC_CORRECTED / INDEPENDENT_RE_REVIEW_PENDING** (REV-F1-SPEC-001-R3 NEEDS_FIX recorded; SPEC-FOUNDATION-F1-001 v0.4.0 corrected in AG-F1-010 resolving R3-F01–R3-F05; 10 issues SPEC_CORRECTED; pending independent Spec re-review REV-F1-SPEC-001-R4; build NOT AUTHORIZED) |
