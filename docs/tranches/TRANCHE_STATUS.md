...
| **F1** | **Common CAD Contracts** | F0 (SATISFIED) | `CORRECTED_DRAFT (v0.5.0) / INDEPENDENT_RE_REVIEW_PENDING` | `NONE` | `NOT_STARTED / NOT AUTHORIZED` | NO | **SPEC_CORRECTED / INDEPENDENT_RE_REVIEW_PENDING** (REV-F1-SPEC-001-R4 NEEDS_FIX recorded; SPEC-FOUNDATION-F1-001 v0.5.0 corrected in AG-F1-011 resolving R4-F01–R4-F03; 10 issues SPEC_CORRECTED; pending independent Spec re-review REV-F1-SPEC-001-R5; build NOT AUTHORIZED) |
