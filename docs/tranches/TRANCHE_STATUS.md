...
| **F1** | **Common CAD Contracts** | F0 (SATISFIED) | `NOT_STARTED` | `NONE` | `NOT_STARTED / NOT AUTHORIZED` | NO | **INTAKE_DRAFT / INDEPENDENT_REVIEW_PENDING** (INTAKE-FOUNDATION-F1-001 created; 10 issues registered in ISSUES.md; pending independent review; DESIGN not yet authorized; zero build authorized) |
