...
| **F1** | **Common CAD Contracts** | F0 (SATISFIED) | `NOT_STARTED` | `NONE` | `NOT_STARTED / NOT AUTHORIZED` | NO | **DESIGN_CORRECTED / INDEPENDENT_RE_REVIEW_PENDING** (REV-F1-DESIGN-001 returned NEEDS_FIX; architectural design, API verification, and issues corrected in AG-F1-005; pending REV-F1-DESIGN-001-R2; SPEC not started; build NOT AUTHORIZED) |
