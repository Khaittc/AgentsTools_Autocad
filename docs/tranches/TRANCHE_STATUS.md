...
| **F1** | **Common CAD Contracts** | F0 (SATISFIED) | `CORRECTED_DRAFT (v0.3.0) / INDEPENDENT_RE_REVIEW_PENDING` | `NONE` | `NOT_STARTED / NOT AUTHORIZED` | NO | **SPEC_CORRECTED / INDEPENDENT_RE_REVIEW_PENDING** (REV-F1-SPEC-001-R2 NEEDS_FIX recorded; SPEC-FOUNDATION-F1-001 v0.3.0 corrected in AG-F1-009 resolving R2-F01–R2-F06; 10 issues SPEC_CORRECTED; pending independent Spec re-review REV-F1-SPEC-001-R3; build NOT AUTHORIZED) |
