...
| **F1** | **Common CAD Contracts** | F0 (SATISFIED) | `NOT_STARTED` | `NONE` | `NOT_STARTED / NOT AUTHORIZED` | NO | **READY_FOR_INTAKE** (Dependency F0 satisfied/frozen; unblocked for planning and intake only; zero code, zero spec, zero build authorized) |
